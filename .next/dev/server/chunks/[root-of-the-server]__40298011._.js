...
async function getGlobalConfig() {
    try {
        const collection = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$collections$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGlobalConfigCollection"])();
        const config = await collection.findOne({});
        if (!config) {
            // Initialize with default config if none exists
            await collection.insertOne({
                ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["defaultConfig"],
                createdAt: new Date(),
                updatedAt: new Date()
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["defaultConfig"];
        }
        return config;
    } catch (error) {
...
"[project]/app/api/admin/config/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$config$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/services/config.service.ts [app-route] (ecmascript)");
;
;
async function GET() {
    try {
        const config = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$config$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGlobalConfig"])();
...
async function PUT(request) {
    try {
        ...
        const config = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$config$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateGlobalConfig"])(body);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            config
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__40298011._.js.map